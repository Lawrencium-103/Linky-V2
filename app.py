"""
Linky V2 - Professional AI-Powered LinkedIn Content Generator
...
# Page configuration
st.set_page_config(
    page_title="Linky - AI LinkedIn Content Generator",
    page_icon="🔗",
    layout="wide",
...
with col_header1:
    ...
    <div class="glass-panel" style="padding: 1.5rem; display: flex; align-items: center; justify-content: space-between;">
        <div>
            <h1 class="premium-header" style="font-size: 2.5rem; text-align: left; margin: 0;">LINKY</h1>
...
<div style="text-align: center; color: #a0aec0; padding: 2rem;">
    <p style="font-family: 'Space Grotesk'; font-size: 1.1rem; margin-bottom: 0.5rem;">LINKY V2.0 PRO</p>
